...
install -p -D -m 600 heat-config/os-apply-config/templates/etc/os-collect-config.conf %{buildroot}%{_libexecdir}/os-apply-config/templates/etc/os-collect-config.conf
