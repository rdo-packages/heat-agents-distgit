...
Requires: python2-heat-agent = %{version}-%{release}
Requires: python2-heat-agent-puppet = %{version}-%{release}
Requires: python2-heat-agent-ansible = %{version}-%{release}
Requires: python2-heat-agent-apply-config = %{version}-%{release}
Requires: python2-heat-agent-hiera = %{version}-%{release}
Requires: python2-heat-agent-json-file = %{version}-%{release}
Requires: python2-heat-agent-docker-cmd = %{version}-%{release}

%description
Heat software config agent and hook scripts

%if 0%{?with_python3}
%package -n python3-heat-agents
Summary: Heat software config agent and hook scripts
# Install all subpackages when main package is installed
...
%description -n python3-heat-agents
Heat software config agent and hook scripts
%endif
